...
joblib.dump(gk_ran_for, 'models/gk_ran_for.joblib')
...
joblib.dump(def_ran_for, 'models/def_ran_for.joblib')
...
joblib.dump(mid_ran_for, 'models/mid_ran_for.joblib')
...
joblib.dump(fwd_ran_for, 'models/fwd_ran_for.joblib')